package org.motechproject.commcarestdemo.osgi;
...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationContext-commcare-scheduletracking-demo.xml";
    private static final String SERVLET_URL_MAPPING = "/commcarestdemo";
    ...
    public static class CommcareStDemoApplicationContext extends OsgiBundleXmlWebApplicationContext {

        public CommcareStDemoApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(CommcareStDemoApplicationContext.class);

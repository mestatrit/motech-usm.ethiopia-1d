...
//    public ModelAndView unenroll(HttpServletRequest request,
//            HttpServletResponse response) {
//
//        ModelAndView mav = new ModelAndView(
//                "redirect:/gates-ethiopia/enrollments/view");
//
...
//            DateTime enrollTime;
//
//            enrollTime = now.withHourOfDay(hour).withMinuteOfHour(minute)
//                    .withDayOfWeek(day);
//
...
//            } else {
//                enrollTime = now.withHourOfDay(hour).withMinuteOfHour(minute)
//                        .withDayOfWeek(day).minusWeeks(1);
//            }
//
...
//
//            hewEnrollmentService.enrollHEW(caseId,
//                    MotechConstants.SCHEDULE_NAME, date, theTime, null);
//
...
//    }
    ...
    public ModelAndView enrollAll(HttpServletRequest request,
            HttpServletResponse response) {
...
//    public ModelAndView unenrollAll(HttpServletRequest request,
//            HttpServletResponse response) {
//
...
//        try {
//            hewList = caseService
//                    .getAllCasesByType(CommcareConstants.CASE_TYPE);
//        } catch (Exception e) {
...
//        }
//
//        hewEnrollmentService.unenrollAllHEWs(hews,
...
//    }
    ...
    public ModelAndView enrollAllEvenIfCompleted(HttpServletRequest request,
            HttpServletResponse response) {
        // TODO
        return null;
    }

    private void raiseAccessEvent(String accessAttempt, String caseId,

...
public class Activator implements BundleActivator {
    ...
    private static final String SERVLET_URL_MAPPING = "/commcare-mapping";
    ...
    public static class CommcareMappingContext extends OsgiBundleXmlWebApplicationContext {

        public CommcareMappingContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(CommcareMappingContext.class);

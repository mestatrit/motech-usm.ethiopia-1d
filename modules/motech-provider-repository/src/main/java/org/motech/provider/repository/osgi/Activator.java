package org.motech.provider.repository.osgi;
...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationProviderRepository.xml";
    private static final String SERVLET_URL_MAPPING = "/providerrepository";
    ...
    public static class ProviderRepositoryApplicationContext extends OsgiBundleXmlWebApplicationContext {

        public ProviderRepositoryApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(ProviderRepositoryApplicationContext.class);

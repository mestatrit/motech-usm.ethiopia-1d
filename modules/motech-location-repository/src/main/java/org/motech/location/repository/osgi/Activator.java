package org.motech.location.repository.osgi;
...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationLocationRepository.xml";
    private static final String SERVLET_URL_MAPPING = "/locationrepository";
    ...
    public static class LocationRepositoryApplicationContext extends OsgiBundleXmlWebApplicationContext {

        public LocationRepositoryApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(LocationRepositoryApplicationContext.class);
